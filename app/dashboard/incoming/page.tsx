...
export default function IncomingPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!newItem.itemName || !newItem.sku || !newItem.supplier || !newItem.quantity) {
      alert('Mohon lengkapi semua field yang diperlukan');
      return;
    }

    console.log('Saving new incoming item:', newItem);

    const newItemWithDefaults = {
      id: incomingData.length + 1,
    ...
    incomingData.unshift(newItemWithDefaults);
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div className="relative rounded-md shadow-sm">
          ...
          <input
            ...
            placeholder="Cari berdasarkan nama, SKU, atau supplier"
          />
        </div>
                  ...
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <p className="mt-2 text-sm text-gray-500">
                        Lengkapi informasi barang masuk di bawah ini. Field dengan tanda * wajib diisi.
                      </p>
                    </div>
                  </div>
                </div>
